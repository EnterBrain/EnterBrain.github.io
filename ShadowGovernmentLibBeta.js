...
function Main(){
	...
	$('<br><a id="SGSettingsButton" class="button foundation-style" title="Shadow Government Settings" href="editCitizen.html?Settings"><i class="icon-star"></i>SG Settings</a>').insertAfter($(".foundation-right.hidden-overflow > div:first > a:first"));
...
function NewBruteForceCitizenForm(){
    ...
    BruteforceCitizenNuber.val($.jStorage.get('SGMotivateTopCitizen', 0));
    BruteforceCitizenButton.click(function(){
        if (BruteforceCitizenButton.attr("status")=="disable"){
            var MotivateUserID = parseInt(BruteforceCitizenNuber.val());
            var motivateType = parseInt(BruteforceMotivateType.val());
